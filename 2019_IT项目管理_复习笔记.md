# 2019IT项目管理复习笔记Ver2.0

## 整理人：彭晓轩

## Ver1.0整理日期：2019/11/26

## Ver2.0整理日期：2019/11/27

##### 修改说明：Ver2.0额外补充了部分知识点以及修正了部分拼写错误
...
**Contingency reserves** allow for future situations that may be partially planned for(**known unknowns**) and are included in the project cost baseline.
...
- 左上方：Compliance（Blue） It
- 左下方：Steadiness（Green） You
- 右上方：Dominance（Red） I
- 右下方：Influence（Yellow） We
